    ...
    def learning(self,lambda_,gamma,alpha,max_episode_num):
        ...
        while num_episode <= max_episode_num:
            ...
            while not is_done:
                ...
                self._assert_state_in_QE(s1,randomized = False)
                a1 = self.performPolicy(s1,num_episode)

                delta = r1 + gamma * self._get_(self.Q,s1,a1) - self._get_(self.Q,s0,a0)


                old_E = self._get_(self.E,s0,a0)+1
                self._set_(self.E,s0,a0,old_E)
...
def main():
    ...
    env.start = (0,0)
    env.ends = [(9,0)]
    env.rewards = [(9,0,100),(1,0,-100),(2,0,-100),(3,0,-100),(4,0,-100),(5,0,-100),(6,0,-100),(7,0,-100),(8,0,-100)]
    env.refresh_setting()
    #env = WindyGridWorld()
